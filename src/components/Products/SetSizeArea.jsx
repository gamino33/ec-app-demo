    ...
    return(
        <div>
            <TableContainer component={Paper}>
                ...
                <div>
                    <TextInput
                        fullWidth={false} label={"サイズ"} multiline={false} required={true} onChange={inputSize} value={size} type={"text"} rows={1}
                    />
                    <TextInput
                        fullWidth={false} label={"数量"} multiline={false} required={true} onChange={inputQuantity} value={quantity} type={"number"} rows={1}
                    />
                </div>
